...
protocol ___VARIABLE_sceneName___ConfiguratorProtocol {
    func configure___VARIABLE_sceneName___Module(with viewController: ___VARIABLE_sceneName___ViewController?) -> ___VARIABLE_sceneName___ViewController?
}

final class ___VARIABLE_sceneName___Configurator: ___VARIABLE_sceneName___ConfiguratorProtocol {
    func configure___VARIABLE_sceneName___Module(with viewController: ___VARIABLE_sceneName___ViewController?) -> ___VARIABLE_sceneName___ViewController? {
